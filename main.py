...
while(CREATE_INDEX <= CREATE_PROFILE_COUNT):
    # try:
        ...
        driver1.find_element(By.ID, "first-name-input").send_keys(first_name)
        driver1.find_element(By.ID, "last-name-input").send_keys(last_name)
        ...
        if hasResume:
            ...
            # driver.execute_script('arguments[0].style = ""; arguments[0].style.display = "block"; arguments[0].style.visibility = "visible";', child_file_selector)
            ...
            def input_skills(skill, driv):
                # skillsInput = WebDriverWait(driv, 45).until(EC.element_to_be_clickable((By.CSS_SELECTOR, "input[aria-labelledby=\"skills-input\"]")))
            ...
            # input_skills(SKILL_SET[0], driver)
            # skill_elements = driver.find_elements(By.CSS_SELECTOR, "button[data-ev-label=\"tokenizer_delete_token\"]")
            # skill_elements[0].click()
